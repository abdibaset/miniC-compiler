...
LLVMModuleRef createLLVMModel(char *filename)
{
    ...
    LLVMMemoryBufferRef moduleBuffer = 0;
    LLVMModuleRef module = 0;

    LLVMCreateMemoryBufferWithContentsOfFile(filename, &moduleBuffer, &error);
    ...
    LLVMParseIRInContext(LLVMGetGlobalContext(), moduleBuffer, &module, &error);
